...
/// </summary>
/// <param name="date">Дата когда была произведена транзакция</param>
...
public class Transaction(DateTime date, Guid accountId, Guid categoryId, decimal amount, string? description = null)
    : IdentityModel
{
    /// <summary>
